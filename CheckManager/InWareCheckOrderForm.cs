...
{
    public partial class InWareCheckOrderForm : Telerik.WinControls.UI.RadForm
    {
        ...
        public InWareCheckOrderForm()
        {
            ...
            InitGrid();
            inwarecheckQueryControl1.StartDateTime = System.DateTime.Now.AddDays(-7);
            inwarecheckQueryControl1.EndDateTime = System.DateTime.Now.AddDays(1);
            inwarecheckQueryControl1.QueryReturnData += checkQueryControl1_QueryReturnData;
            inwarecheckQueryControl1.QueryMessage += checkQueryControl1_QueryMessage;
            ...
            tsbDiscard = OrderGV.AddToolBarButton("废弃样品单", Properties.Resources.Discard48, true, ToolStripItemDisplayStyle.ImageAndText);
            tsbDiscard.Enabled = false;
            tsbDiscard.Click += tsbDiscard_Click;

            tsbDel = OrderGV.AddToolBarButton("删除样品单", Properties.Resources.DeleteOrder, true, ToolStripItemDisplayStyle.ImageAndText);
        ...
        private void InitGrid()
        {
            ...
            string[] StateNames = new string[] { SampleTypeEnum.PackageInWare.GetDescription() };
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            CreateCheckOrderForm form = new CreateCheckOrderForm(SampleTypeEnum.PackageInWare);
            form.Tag = Tag;
            form.ShowDialog();
        ...
        private void btnAddData_Click(object sender, EventArgs e)
        {
            if (OrderGV.SelectedItems.Count == 1)
            {
                ...
                if(order.CheckOrderState== CheckOrderStateEnum.Discard)
                {
                    MessageBox.Show("该工单已被废弃，无法录入数据");
                    return;
                }
