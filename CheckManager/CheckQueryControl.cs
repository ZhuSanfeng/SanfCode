...
namespace SSIT.QM.CheckManager
{
    ...
    public partial class CheckQueryControl : UCQueryControl//QueryControlBase<CheckOrder>
    {
        #region 属性方法
       ...
       private void InitControl()
       {
          ...
          var keys = dic.Keys.Where(p => p != CheckOrderStateEnum.Discard.GetDescription());
           ...
           mutiSelectField1.Init(dic);
            var typekeys = dic.Keys.Where(p => p == SampleTypeEnum.PackagesComming.GetDescription());
    ...
    public class UCQueryControl : QueryControlBase<CheckOrder> { }
}
